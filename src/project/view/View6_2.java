 ...
 */
public class View6_2 {//registro chaza
    ...
    public View6_2() {
        ...
        this.grid.setPadding(new Insets(60.5, 12.5, 13.5, 14.5));
        ...
        horario.textFillProperty().set(Color.WHITE);
        this.inHorario = new TextField();
        this.b1 = new Button("Registrarse");
        this.confirmar=new Label("");
        this.b1.setMaxWidth(Double.MAX_VALUE);
        VBox vbox = new VBox(name, this.inName,user, this.inUser, password, this.inPass, phone, this.inPhone,horario,this.inHorario, this.confirmar, this.b1);
        vbox.setSpacing(10);
    ...
    public TextField getInHorario() {
        return inHorario;
    }

    public void setInHorario(TextField inHorario) {
